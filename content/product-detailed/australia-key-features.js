...
const EXP_UNLIM =
  "雪梨、墨爾本、布里斯本、黃金海岸等都會區 4G／5G 測速常見可到數十 Mbps，內陸、沙漠與偏遠地區會明顯下降。吃到飽為 FUP，不會固定鎖死某一 Mbps，繁忙時段可能變慢。導航、傳訊通常沒問題。出網為新加坡 IP。僅供參考。";

const EXP_TOTAL =
  "高速額度內：都會區 4G／5G 測速常見可到數十 Mbps。高速用完後降速約 128kbps 可持續使用——傳訊／輕量網頁勉強可以，影音與熱點會明顯困難。請依總量額度規劃用量。出網為新加坡 IP。僅供參考。";

const EXP_DAILY =
  "每日高速額度內：都會區 4G／5G 測速常見可到數十 Mbps。額度用完後降速約 128kbps，隔日重置——傳訊／輕量網頁勉強可以，影音與熱點會明顯困難。出網為新加坡 IP。僅供參考。";

export function australiaOptusUnlimitedKeyFeatures() {
  return pack(
    [
      "本方案為 **Optus** 澳洲吃到飽 eSIM（批發 SKU `Australia-unlimited*`），覆蓋澳洲主要城市與交通沿線。",
      "**為什麼選擇 Optus 吃到飽？**",
...
export function australiaOptusTotalKeyFeatures() {
  return pack(
    [
      "本方案為 **Optus** 澳洲總量型 eSIM（批發 SKU `Australia-Total*`），覆蓋澳洲主要城市與交通沿線。",
      "**為什麼選擇 Optus 總量型？**",
      "**Optus 4G／5G**：澳洲主流電信之一，雪梨、墨爾本、布里斯本、黃金海岸、珀斯等熱門行程較穩。",
...
export function australiaOptusDailyKeyFeatures() {
  return pack(
    [
      "本方案為 **Optus** 澳洲每日型 eSIM（批發 SKU `Australia-Daily*`），覆蓋澳洲主要城市與交通沿線。",
      "**為什麼選擇 Optus 每日型？**",
      "**Optus 4G／5G**：澳洲主流電信之一，雪梨、墨爾本、布里斯本、黃金海岸、珀斯等熱門行程較穩。",
