...
const EXP_UNLIM_10 =
  "伊斯坦堡、安卡拉、伊茲密爾、安塔利亞等都會區 4G／5G 測速常見可到數十 Mbps；卡帕多奇亞、海岸公路與偏遠地區會下降。每日 1GB 高速用完後限速約 10Mbps 可持續使用——導航、傳訊、社群通常沒問題，高畫質影音與熱點會變慢。出網為英國／波蘭 IP。僅供參考。";

export function trAveaUnlimited10MbpsKeyFeatures() {
  return pack(
    [
      "本方案為 **土耳其** 吃到飽 eSIM（批發 SKU `Turkey-unlimited-*-A1`），覆蓋伊斯坦堡與主要觀光路線。",
...
const EXP_TOTAL =
  "高速額度內：伊斯坦堡、安卡拉、伊茲密爾、安塔利亞等都會區 4G／5G 測速常見可到數十 Mbps。高速用完後降速約 128kbps 可持續使用——傳訊／輕量網頁勉強可以，影音與熱點會明顯困難。請依總量額度規劃用量。出網為英國／波蘭 IP。僅供參考。";

export function trAveaTotalKeyFeatures() {
  return pack(
    [
      "本方案為 **土耳其** 總量型 eSIM（批發 SKU `Turkey-Total*-A1`），覆蓋伊斯坦堡與主要觀光路線。",
...
const EXP_DAILY =
  "每日高速額度內：伊斯坦堡、安卡拉、伊茲密爾、安塔利亞等都會區 4G／5G 測速常見可到數十 Mbps。額度用完後降速約 128kbps，隔日重置——傳訊／輕量網頁勉強可以，影音與熱點會明顯困難。出網為英國／波蘭 IP。僅供參考。";

export function trAveaDailyKeyFeatures() {
  return pack(
    [
      "本方案為 **土耳其** 每日型 eSIM（批發 SKU `Turkey-Daily*-A1/A3`），覆蓋伊斯坦堡與主要觀光路線。",
