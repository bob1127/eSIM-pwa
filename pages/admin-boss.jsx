...
import BossLineWelcomePreviewPanel from "@/components/admin/BossLineWelcomePreviewPanel";
...
export default function AdminBossDashboard() {
  ...
  const tabs = [
    ...
    { id: "line-welcome", label: "LINE歡迎設計" },
  ...
  const content = (
    <>
      ...
      {bossTab === "line-welcome" && <BossLineWelcomePreviewPanel />}
