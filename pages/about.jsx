    ...
    <Layout flushTop>
      ...
      <section className="section-company-intro pt-10 lg:pt-20">
        ...
        <div className="flex flex-col lg:flex-row lg:min-h-[400px] group border-b border-gray-200 lg:border-b-0">
          ...
          <div className="w-full lg:w-[5%] h-12 lg:h-auto border-b lg:border-b-0 lg:border-r border-gray-200 flex flex-row lg:flex-col justify-between lg:justify-center items-center px-4 lg:px-0 bg-gray-50 lg:bg-transparent">
            <p className="font-bold text-[13px] text-gray-500 group-hover:text-black duration-500 lg:rotate-90 lg:mb-8">
              01
            </p>
            <p className="text-[13px] lg:text-[14px] font-bold text-gray-500 group-hover:text-black duration-500 lg:rotate-90 lg:my-8">
              ABOUT
            </p>
          </div>
          ...
          <div className="w-full lg:w-[85%] lg:border-r border-gray-200 h-full flex justify-center items-center">
            <div className="flex flex-col p-6 lg:p-10 w-full">
              {/* 標題區域 */}
              <h1 className="text-[22px] sm:text-[26px] lg:text-[28px] font-bold text-black leading-[1.35] mb-2 tracking-normal">
                Jeko 接口 eSIM
              </h1>
              <p className="text-[18px] sm:text-[20px] font-bold text-black mb-4 leading-[1.5]">
                成為你與世界的接口
              </p>
              <p className="mb-6 text-[15px] lg:text-[16px] font-bold text-black leading-[28px]">
                台灣在地｜日本・韓國原生高速｜泰國・越南・中國・香港
              </p>

              {/* 內文區域：手機垂直堆疊，桌機水平排列 */}
              <div className="flex flex-col lg:flex-row gap-6 lg:gap-12 max-w-[1500px]">
                <p className="flex-1 text-black text-[15px] lg:text-[16px] font-normal leading-[28px] tracking-normal">
      ...
      <section className="section-company-intro border-b border-gray-200 lg:border-none">
        <div className="flex flex-col lg:flex-row h-auto lg:min-h-[600px] group">
          ...
          <div className="w-full lg:w-[5%] h-14 lg:h-auto bg-black lg:bg-transparent border-b lg:border-b-0 lg:border-r border-gray-200 flex flex-row lg:flex-col justify-between lg:justify-center items-center px-4 lg:px-0 z-10">
            <p className="font-bold text-[13px] text-gray-400 group-hover:text-white lg:group-hover:text-black duration-500 lg:rotate-90 lg:mb-8">
              02
            </p>
            <p className="text-[13px] lg:text-[14px] font-bold text-gray-400 group-hover:text-white lg:group-hover:text-black duration-500 lg:rotate-90 lg:my-8">
              eSIM
            </p>
          </div>
          ...
          <div className="w-full lg:w-[50%] xl:w-[65%] lg:border-r border-gray-200 h-full p-6 md:p-10 xl:p-20">
            <div className="max-w-[600px]">
              <h2 className="text-[22px] sm:text-[24px] lg:text-[28px] font-bold leading-[1.35] text-black tracking-normal">
                Jeko eSIM。
                <br />
                旅途不斷線的接口
              </h2>
              <p className="mt-5 text-[15px] lg:text-[16px] font-normal leading-[28px] text-black">
                Jeko eSIM
              ...
              <Link
                href="/product/"
                className="group/btn inline-flex items-center px-8 py-3 rounded-full mt-8 text-white font-bold text-[14px] bg-gradient-to-r from-[#0059b8] via-[#0071cf] to-[#0095e6] shadow-md transition-all duration-300 hover:brightness-110 hover:shadow-lg hover:-translate-y-1"
              >
                eSIM 產品
          ...
          <div className="w-full lg:w-[45%] xl:w-[30%] h-full flex justify-center items-center border-t lg:border-t-0 border-gray-200">
            <div className="p-6 md:p-10 xl:p-20">
              <h3 className="text-[18px] sm:text-[20px] text-black font-bold mb-4 leading-[1.4]">
                即掃即用，隨時上線
              </h3>
              <p className="leading-[28px] text-black text-[15px] lg:text-[16px] font-normal text-justify">
                全新 eSIM 服務提供 24HR
      ...
      <section className="section-company-intro">
        <div className="mx-auto w-full max-w-[1500px] px-6 lg:px-10 py-12 lg:py-16">
          <h2 className="text-[22px] sm:text-[24px] lg:text-[28px] font-bold text-black leading-[1.35] tracking-normal">
            全球旅遊 eSIM，
            <br />
            落地就能上網
          </h2>
          <p className="mt-4 text-[16px] sm:text-[18px] font-bold text-[#666666] leading-[1.5]">
            熱門目的地方案齊全，即掃即用，旅途不斷線。
          </p>

          <div className="mt-10 grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-12 items-start">
            <div>
              <h3 className="text-[18px] font-bold text-black mb-3 min-h-[1.75rem] leading-[1.4]">
                eSIM，即掃即用
              </h3>
              <p className="text-black text-[15px] lg:text-[16px] font-normal leading-[28px] tracking-normal">
          ...
          <div className="mt-10 flex flex-col sm:flex-row gap-3">
            <Link
              href="/cooperation"
              className="inline-flex items-center justify-center rounded-full bg-[#0A6CD0] px-7 py-3 text-[14px] font-bold text-white transition-all duration-300 hover:brightness-110 hover:-translate-y-0.5"
            >
              了解合作方式
            </Link>
            <Link
              href="/contact"
              className="inline-flex items-center justify-center rounded-full border border-gray-300 bg-white px-7 py-3 text-[14px] font-bold text-black transition-all duration-300 hover:border-[#0A6CD0] hover:text-[#0A6CD0]"
            >
              聯絡我們
            </Link>
          </div>
        ...
        <div className="mx-auto max-w-7xl px-6 py-16 md:py-24">
          <div className="grid items-center gap-12 lg:gap-20 md:grid-cols-2">
            ...
            <div className="text-white flex flex-col justify-center">
              <h2 className="text-[22px] sm:text-[24px] lg:text-[28px] font-bold tracking-normal leading-[1.35] text-white">
                出國前一定要知道的{" "}
              ...
              <div className="mt-8 md:mt-10">
                <Link
                  ...
                  className="
                    ...
                    bg-white px-6 py-3 text-[14px] font-bold text-[#1f57b8]
