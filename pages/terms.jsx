  ...
  return (
    <LegalPageLayout
      ...
      seo={{
        ...
        description:
          "Jeko eSIM 服務條款：說明 eSIM 購買、使用、退款、合作夥伴分潤，以及自訂文章／上傳內容免責。",
      }}
    ...
    >
      <LegalSection title="一、服務說明與適用範圍">
        <p>
          ...
          數位商品販售、會員帳戶、合作夥伴方案（專屬連結／專屬商店）、自訂文章及相關旅遊加值服務。
      ...
      <LegalSection title="四、付款、發票與退款">
        <ul>
          ...
          <li>
            為防止惡意重複下單退款，同一顧客於短期間內核准退款次數達上限時，線上申請得暫時關閉並改由官方
            LINE 人工處理。經認定惡意濫用者，本平台得暫停或永久停用其帳號／購買權限，並保留法律追訴權利。
          </li>
          <li>
      ...
      <LegalSection title="五、合作夥伴方案（專屬連結／專屬商店）">
        ...
        <ul>
          <li>
            經本平台開通「自訂文章」後，合作夥伴得於專屬商店發布原創文章及上傳圖片、影音、嵌入社群貼文等內容。該等內容由夥伴自行製作、挑選與發布，
            <strong>不代表本平台審核通過、背書或擔保</strong>其真實性與合法性。
          </li>
          <li>
            夥伴應確保所發布之一切文字、圖片、影音、字型、商標、嵌入內容及其他資產，均為合法取得授權或屬夥伴自有著作，且未侵害第三人著作權、商標權、肖像權、隱私權或其他權利。
          </li>
          <li>
            <strong>完整免責：</strong>
            若夥伴將本平台（含專屬商店、文章系統、媒體上傳、社群嵌入）用於非法用途，或使用無版權、未取得合法授權之資產，因此所生之一切民刑事責任、行政罰鍰、第三人損害賠償、律師費用及其他損失，
            <strong>概由該合作夥伴自行承擔</strong>。Jeko eSIM 及藍鏈數位企業社
            <strong>不負賠償、連帶或補充責任</strong>。
          </li>
          <li>
            第三人就夥伴內容主張權利時，本平台得立即下架該內容、暫停自訂文章功能或終止合作，並得向該夥伴追償本平台因此支出之費用與損失。
          </li>
        </ul>
      </LegalSection>
      ...
      <LegalSection title="六、智慧財產權">
        ...
        <p>
          合作夥伴自行上傳或嵌入之內容，其智慧財產權仍歸原權利人所有；夥伴僅於其有權範圍內授權本平台為提供服務所必要之重製、公開傳輸與儲存。夥伴不得上傳其無權使用之素材；違反者由夥伴自負侵權責任，本平台不負責。
        </p>
      </LegalSection>
      ...
      <LegalSection title="七、免責聲明與責任限制">
        <ul>
          ...
          <li>
            就合作夥伴自行發布之文章、圖片、影音、嵌入內容或其他資產，以及夥伴將服務用於非法用途或使用無版權／未授權素材所生之一切損害、爭議與求償，本平台不負任何責任。詳見第五節（五）。
          </li>
        </ul>
      </LegalSection>
