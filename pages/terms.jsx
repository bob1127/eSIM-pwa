    ...
    >
      ...
      <LegalSection title="四、付款、發票與退款">
        <ul>
          ...
          <li>
            <strong>本平台支援開立電子發票。</strong>
            付款完成後，電子發票將依您填寫之 Email
            或會員資料開立；如需統編發票，請於結帳時正確填寫統一編號與發票抬頭。
          </li>
          <li>
            非原生／漫遊 eSIM：未安裝或已安裝但未激活者得全額退款；已激活原則不予退款；連線問題由客服協助排查，並視情況更換
            eSIM 或部分退款。原生 eSIM：售出後概不退款或換貨。詳見{" "}
            <a href="/refund-policy">退換貨政策</a>。
          </li>
          <li>
