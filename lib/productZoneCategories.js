...
/** @typedef {{ code: string, name: string, slug: string, desc: string, hotSale?: boolean }} ZoneCountry */
...
export function zoneCountryToServiceCard(country, pillLabel) {
  return {
