...
export function buildProductSeo(product, variation, categoryHandle, extras = {}) {
  ...
  const keywords =
    customKeywords ||
    `${baseName},${productSubtitle || ""},${variantLabel || ""},${product?.name || ""} eSIM,旅遊eSIM,出國上網,Jeko eSIM,免換卡,${PRODUCT_AGGREGATE_RATING.ratingValue}星`;
  ...
  return {
    ...
    ogImageAlt: `${productName}｜Jeko eSIM ${PRODUCT_AGGREGATE_RATING.ratingValue} 星評價`,
    ogType: "product",
