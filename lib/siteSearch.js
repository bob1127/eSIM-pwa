...
export const LEGAL_ENTRIES = [
  ...
  // 退換貨
  {
    ...
    title: "商品性質與重要提醒",
    href: "/refund-policy",
    keywords: "退換貨 數位商品 開通 無法退貨",
    excerpt: "eSIM 數位商品開通即視為交付之重要提醒。",
  },
  {
    id: "refund-unused",
    source: "refund",
    title: "未開通 — 可退款（全額）",
    href: "/refund-policy",
    keywords: "未開通 退款 7日 qrcode 未掃描",
    excerpt: "購買後 7 日內、尚未啟用之全額退款條件。",
  },
  {
    id: "refund-activated",
    source: "refund",
    title: "已開通之例外與不可退情形",
    href: "/refund-policy",
    keywords: "已開通 例外 不可退 相容",
    excerpt: "已安裝／啟用後原則不可退及例外說明。",
  },
  {
    id: "refund-process",
    source: "refund",
