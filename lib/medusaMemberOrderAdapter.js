...
/** metadata.esim_qrcodes → 會員頁 qrcode_data 陣列（名稱原樣透傳） */
  ...
  return list
    .map((it, idx) => {
      ...
      return {
        ...
        validityPeriod: it.validityPeriod || it.validity_period || "",
        networks: it.networks || "",
        planOfficialName: it.planOfficialName || "",
        dataAllowance: it.dataAllowance || "",
        specialDesc: it.specialDesc || "",
