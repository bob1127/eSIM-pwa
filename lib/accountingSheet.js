...
export async function setupAccountingDashboard() {
  ...
  const rows = [
    ...
    ["銷售額", ...metric(sumF(m, "E"), sumF(s, "E"), sumF(r, "E"))],
    ["成本(估)", ...metric(sumF(m, "H"), sumF(s, "H"), sumF(r, "H"))],
    ["毛利(估)", ...metric(sumF(m, "I"), sumF(s, "I"), sumF(r, "I"))],
    ["手續費(估)", ...metric(sumF(m, "F"), sumF(s, "F"), sumF(r, "F"))],
    ["淨利(估)", "=B8-B9", "=C8-C9", "=D8-D9", "=E8-E9"],
    ["毛利率", '=IF(B6=0,"",B8/B6)', '=IF(C6=0,"",C8/C6)', '=IF(D6=0,"",D8/D6)', '=IF(E6=0,"",E8/E6)'],
    ["", "", "", "", ""],
    ["── 本月 ──", "", "", "", ""],
    ["本月銷售額", ...metric(sumIfMonthF(m, "E"), sumIfMonthF(s, "E"), sumIfMonthF(r, "E"))],
    ["本月毛利(估)", ...metric(sumIfMonthF(m, "I"), sumIfMonthF(s, "I"), sumIfMonthF(r, "I"))],
    [
      "本月訂單筆數",
      ...metric(
        `=COUNTIFS(${m}!A2:A,">="&DATE(YEAR(TODAY()),MONTH(TODAY()),1),${m}!A2:A,"<="&EOMONTH(TODAY(),0),${m}!B2:B,"<>")`,
        `=COUNTIFS(${s}!A2:A,">="&DATE(YEAR(TODAY()),MONTH(TODAY()),1),${s}!A2:A,"<="&EOMONTH(TODAY(),0),${s}!B2:B,"<>")`,
        `=COUNTIFS(${r}!A2:A,">="&DATE(YEAR(TODAY()),MONTH(TODAY()),1),${r}!A2:A,"<="&EOMONTH(TODAY(),0),${r}!B2:B,"<>")`,
      ),
    ],
    ["", "", "", "", ""],
    ["說明", "", "", "", ""],
