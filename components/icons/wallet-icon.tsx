...
const WalletIcon = forwardRef<AnimatedIconHandle, AnimatedIconProps>(
  (
    ...
    const stop = async () => {
      animate(".flap", { rotateY: 0, x: 0 }, { duration: 0.3, ease: "easeIn" });
      animate(".wallet-body", { scale: 1 }, { duration: 0.3, ease: "easeIn" });
    };
    ...
    return (
      ...
      >
        ...
        />
        <motion.path className="flap" d="M20 12v4h-4a2 2 0 0 1 0 -4h4" />
      </motion.svg>
    );
  },
);
